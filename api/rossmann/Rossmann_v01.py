...
#    "Dentro do método data_preparation(self, df5) não deveria ser utilizado o método transform nos scalers ao invés de fit_transform? Se for utilizado o fit_transform os scalers serão ajustados novamente do 0, perdendo o sentido de carregá-los utilizando a biblioteca pickle." CORRIGIDO
